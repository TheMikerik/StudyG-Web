        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-[380px] shrink-0">
            ...
            >
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-black mb-6 tracking-tighter leading-[1.1]">
                {subcategory.name}
              </h1>

              <p className="text-gray-600 text-[15px] font-light leading-relaxed mb-10 max-w-sm">
              ...
              <div className="flex items-center gap-6 p-6 rounded-2xl bg-gray-50 border border-black/5">
                <div className="w-12 h-12 rounded-full bg-black/5 flex items-center justify-center text-gray-600">
                  <LayoutGrid className="w-5 h-5" />
                </div>
                <div>
                  <div className="text-3xl font-bold text-black tracking-tight leading-none mb-1">
                    {totalCount}
                  </div>
            ...
            >
              {topics.length === 0 ? (
                <div className="card-premium rounded-3xl p-12 border border-black/5 flex flex-col items-center justify-center text-center h-full min-h-[400px]">
                  ...
                  <h3 className="text-xl font-bold text-black mb-2 tracking-tight">No topics published yet.</h3>
                ...
                <div className="bg-white rounded-[2rem] border border-black/10 overflow-hidden shadow-2xl">
                  ...
                  >
                    {topics.map((topic, index) => {
                      ...
                      return (
                        <motion.li key={topic.slug} variants={itemVariants} className="border-b border-black/5 last:border-0 relative group">
                          <Link
