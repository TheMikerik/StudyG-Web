...
export default async function PostPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 pt-32 pb-24">
      ...
      <header className="mb-12">
        ...
        <div className="flex items-center gap-4 pt-6 border-t border-white/5">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-white text-sm font-bold shrink-0">
              S
            </div>
      ...
      {/* In-post CTA — dark card style */}
      <div className="mt-14 p-8 rounded-3xl bg-[#0a0a0a] border border-white/5 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-white text-black px-6 py-3 rounded-xl font-bold text-sm hover:bg-gray-100 transition-transform hover:scale-105"
        >
