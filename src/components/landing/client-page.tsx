  ...
  return (
    <div className="relative min-h-screen overflow-hidden selection:bg-white/30 selection:text-white">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[40rem] w-[40rem] rounded-full bg-black/[0.03] opacity-50 blur-[100px]" />
      </div>

      {/* Hero Section */}
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-black/[0.05] blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 border border-black/10 text-xs font-medium text-gray-700 mb-8 backdrop-blur-md">
            ...
            <motion.p
              variants={itemVariants}
              className="text-lg text-gray-600 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed font-light"
            >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                ...
                className="group relative flex items-center justify-center gap-3 bg-black text-white px-8 py-4 rounded-xl font-bold text-lg overflow-hidden transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
                <div className="absolute inset-0 translate-y-[100%] bg-gray-800 transition-transform duration-300 group-hover:translate-y-0" />
              ...
              <Link
                href="/blog"
                className="flex items-center justify-center gap-3 bg-black/5 text-black border border-black/10 px-8 py-4 rounded-xl font-medium text-lg hover:bg-black/10 transition-colors"
              >
                Read the Blog
          ...
          >
            {/* Ambient backlight */}
            <div className="absolute inset-0 bg-gradient-to-tr from-black/5 via-black/10 to-transparent blur-3xl opacity-50 rounded-full transition-opacity duration-700 group-hover:opacity-70" />
      ...
      {/* Features bento grid */}
      <section id="features" className="py-32 relative border-t border-black/[0.05] bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="md:col-span-2 card-premium rounded-3xl p-8 md:p-12 relative overflow-hidden group smooth-border border border-black/10 hover:border-black/20"
            >
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 bg-black text-white rounded-2xl flex items-center justify-center mb-8 shadow-lg">
              ...
              {/* Decorative graphic */}
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-black/5 rounded-full blur-3xl group-hover:bg-black/10 transition-colors duration-700" />
              <div className="absolute bottom-5 right-5 w-48 h-48 border border-black/5 rounded-full opacity-20" />
              <div className="absolute bottom-12 right-12 w-32 h-32 border border-black/5 rounded-full opacity-40" />
            </motion.div>
            ...
            <motion.div
              ...
              className="md:row-span-2 card-premium rounded-3xl p-8 relative overflow-hidden group smooth-border border border-black/10 hover:border-black/20 flex flex-col"
            >
              <div className="w-14 h-14 bg-gray-100 border border-black/10 text-black rounded-2xl flex items-center justify-center mb-8 group-hover:bg-black group-hover:text-white transition-colors duration-300 z-10">
                <Sparkles className="w-6 h-6" />
              </div>
              <h3 className="text-2xl font-bold mb-4 z-10 tracking-tight">
                AI-Powered <br /> Creation
              </h3>
              <p className="text-gray-600 z-10 font-light text-sm mb-12">
              ...
              <div className="mt-auto relative z-0 flex flex-col gap-3">
                <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-gray-50 to-transparent z-10" />
                {[
                  ...
                  <div
                    key={i}
                    className="w-full flex items-center gap-3 bg-white/80 p-3 rounded-xl border border-black/5 transform transition-transform group-hover:-translate-y-1"
            ...
            <motion.div
              ...
              className="card-premium rounded-3xl p-8 border border-black/10 hover:border-black/20 smooth-border group"
            >
              <div className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center mb-6 text-gray-700 group-hover:bg-black/10 transition-colors">
      ...
      {/* Deep dives */}
      <section className="py-32 overflow-hidden bg-gray-50 border-t border-black/[0.05]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col gap-40">
          ...
          <div className="flex flex-col md:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              <div className="w-full aspect-square md:aspect-[4/3] rounded-3xl p-1 bg-gradient-to-br from-black/10 to-transparent">
                <div className="w-full h-full bg-white rounded-[22px] border border-gray-200 flex items-center justify-center relative overflow-hidden group">
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,0,0,0.02),transparent)] pointer-events-none" />

                  <div className="w-64 bg-gray-50 border border-black/10 rounded-2xl shadow-2xl flex flex-col items-center justify-center gap-5 p-8 relative z-10 transition-transform duration-500 group-hover:scale-105">
                    <div className="w-16 h-16 bg-red-500/10 text-red-500 rounded-full flex items-center justify-center">
                      <XCircle className="w-8 h-8" />
                    </div>
                    <div className="text-center">
                      <h4 className="text-black font-bold text-lg mb-1">App Blocked</h4>
                      <p className="text-gray-500 text-xs font-medium">Session in progress</p>
                    </div>
                    <button className="w-full py-3 bg-black text-white rounded-xl text-sm font-bold shadow-lg shadow-black/10 hover:scale-[1.02] transition-transform">
                      Return to Focus
                    </button>
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-16 lg:gap-24">
            <motion.div
              ...
              className="w-full md:w-1/2"
            >
              <div className="w-full aspect-square md:aspect-[4/3] rounded-3xl p-1 bg-gradient-to-bl from-black/10 to-transparent">
                <div className="w-full h-full bg-white rounded-[22px] border border-gray-200 flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="w-full max-w-sm p-6 relative z-10 flex flex-col items-center">
                    ...
                    <motion.div
                      ...
                      className="w-full bg-gray-50 border border-black/10 rounded-xl p-4 shadow-xl mb-4 -translate-y-2 group-hover:translate-y-0 transition-transform"
                    >
                      <div className="flex items-center gap-3 mb-2">
                        <FileText className="w-4 h-4 text-gray-500" />
                        <span className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Source Payload</span>
                      </div>
                      <p className="text-sm text-gray-700 font-mono">Biology_101_Lecture.pdf</p>
                    </motion.div>

                    {/* Pipeline connection */}
                    <div className="h-8 w-px bg-gradient-to-b from-black/20 to-transparent my-1" />

                    {/* Output Mock */}
                    <motion.div
                      transition={{ type: "spring", bounce: 0.5, delay: 0.1 }}
                      className="w-[105%] bg-black text-white rounded-xl p-5 shadow-2xl relative z-20 translate-y-2 group-hover:translate-y-0 transition-transform"
                    >
      ...
      {/* Testimonials */}
      <section className="py-32 bg-gray-50 border-t border-black/[0.05]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-20"
          >
            <h2 className="text-4xl font-bold tracking-tight text-black">System Validations</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="card-premium p-8 rounded-3xl border border-black/5 smooth-border hover:border-black/20 flex flex-col h-full"
              >
                ...
                <p className="text-gray-700 mb-8 leading-relaxed font-light text-sm flex-grow">
                  "{review.quote}"
                </p>
                <div className="flex items-center gap-4 mt-auto">
                  <div className="w-12 h-12 rounded-full bg-gray-100 border border-black/10 flex items-center justify-center font-bold text-sm text-black">
                    {review.initial}
                  </div>
                  <div>
      ...
      <section className="py-32">
        <div
          className="bg-black text-white rounded-3xl p-12 md:p-20 text-center relative overflow-hidden max-w-7xl mx-auto px-6"
          id="download"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900 to-black" />
          <div className="absolute top-0 right-0 w-64 h-64 bg-gray-800 rounded-full mix-blend-screen filter blur-3xl opacity-30" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-gray-700 rounded-full mix-blend-screen filter blur-3xl opacity-30" />
          <div className="relative z-10">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-200 transition-transform transform hover:scale-105 shadow-xl"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
              </svg>
